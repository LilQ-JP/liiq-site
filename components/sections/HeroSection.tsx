...
export default function HeroSection() {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-7xl mx-auto px-5 sm:px-8 pt-32 sm:pt-40 pb-16 sm:pb-24 min-w-0">
        {/* Badge */}
        <motion.div
        ...
        {/* Video + Cards */}
        <div className="flex flex-col lg:flex-row gap-5 items-stretch min-w-0">
          {/* Video carousel */}
          <motion.div
                ...
                >
                  {[...works, ...works].map((v, i) => (
                    <div key={i} className="w-[12.5%] px-1.5 flex-none flex flex-col gap-2">
                      <div className="relative w-full overflow-hidden bg-black aspect-[9/16]" style={{ borderRadius: "16px" }}>
                        {v.type === "youtube" ? (
                          <iframe
                      ...
                      <div className="text-[11px] text-white/40 font-medium px-0.5 text-center truncate">
                        {v.channel}
                      </div>
                    </div>
                  ))}
          ...
          {/* Info cards */}
          <motion.div
            className="flex flex-row lg:flex-col gap-3 lg:w-[220px] xl:w-[240px] shrink-0 overflow-x-auto lg:overflow-visible"
